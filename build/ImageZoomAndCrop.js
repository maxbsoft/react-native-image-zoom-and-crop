...
var ImageZoomAndCrop = /** @class */ (function (_super) {
    __extends(ImageZoomAndCrop, _super);
    function ImageZoomAndCrop() {
    ...
    ImageZoomAndCrop.getDerivedStateFromProps = function (props, state) {
    ...
    ImageZoomAndCrop.prototype.componentDidMount = function () {
        this.init();
    };
    ImageZoomAndCrop.prototype.componentDidUpdate = function (prevProps) {
        var imageUri = this.props.imageUri;
        if (imageUri && prevProps.imageUri !== imageUri) {
            this.init();
        }
    };
    ImageZoomAndCrop.prototype.render = function () {
        var _a = this.state, loading = _a.loading, fittedSize = _a.fittedSize, minScale = _a.minScale;
        var _b = this.props, imageUri = _b.imageUri, cropAreaWidth = _b.cropAreaWidth, cropAreaHeight = _b.cropAreaHeight, areaColor = _b.areaColor, areaOverlay = _b.areaOverlay, maxScale = _b.maxScale, constraint = _b.constraint;
        var areaWidth = cropAreaWidth;
        var areaHeight = cropAreaHeight;
        var imageWidth = fittedSize.width;
        var imageHeight = fittedSize.height;
        return (react_1.default.createElement(react_native_gesture_handler_1.GestureHandlerRootView, null, !loading ? (react_1.default.createElement(ImageViewer_1.default, { image: imageUri, areaWidth: areaWidth, areaHeight: areaHeight, imageWidth: imageWidth, imageHeight: imageHeight, minScale: minScale, maxScale: maxScale, onMove: this.handleMove, imageBackdropColor: areaColor, overlay: areaOverlay, constraint: constraint })) : null));
    };
    ImageZoomAndCrop.crop = function (params) {
    ...
    ImageZoomAndCrop.defaultProps = defaultProps;
    return ImageZoomAndCrop;
}(react_1.PureComponent));
exports.default = ImageZoomAndCrop;
